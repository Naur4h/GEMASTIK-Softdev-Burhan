...
// Data alternatif tanaman lain — nanti ganti dengan hasil fetch dari backend
const allAlternatif = [
...
const ALT_TOP_COUNT = 3; // jumlah item yang ditampilkan sebelum "Lihat Semua"
...
export default function DetailTanamanPage() {
  ...
  />
              ...
              <div>
                <h1 className="font-display text-3xl font-bold">Sorghum</h1>
                <p className="mb-3 italic text-cream-light/70">(Sorghum Bicolor)</p>
                <p className="mb-3 text-sm leading-relaxed text-cream-light/90">
                  ...
                  tanah dengan kesuburan rendah sertaa memiliki keburuhan air
                  yang relatif rendah
                </p>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl bg-sand p-5">
              <CircularGauge value={90} label="Skor Kesesuaian" sublabel="Sangat Sesuai" />
            </div>

            <div className="rounded-2xl bg-sand p-5">
              <CircularGauge value={82} label="Tingkat Keyakinan Model" sublabel="Tinggi" />
            </div>

            {/* Alternatif Lain — bisa expand/collapse */}
